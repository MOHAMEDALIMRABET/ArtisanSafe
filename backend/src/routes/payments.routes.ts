...
// ✅ L'ancienne route 'create-connect-account' a été supprimée
// ✅ Utiliser maintenant : POST /api/v1/stripe/onboard (stripe.routes.ts)
// ✅ Nouvelle méthode : Formulaire dans ArtisanDispo au lieu de redirection Stripe
