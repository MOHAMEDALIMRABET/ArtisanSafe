  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-blue-100">
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        {/* Section Mes Devis - Mes Factures (compacte) */}
        <div className="mt-8 bg-white rounded-lg shadow-md p-6">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="text-xl font-bold text-gray-800">Mes Devis - Mes Factures</h3>
                <p className="text-sm text-gray-600">
                  {devisNotifications > 0 ? (
                    <span className="text-[#FF6B00] font-semibold">{devisNotifications} notification{devisNotifications > 1 ? 's' : ''}</span>
                  ) : (
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {/* Devis en attente */}
            <div className="bg-orange-50 rounded-lg p-4 border-l-4 border-[#FF6B00]">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-gray-600 mb-1">En attente</p>
                  <p className="text-2xl font-bold text-[#FF6B00]">-</p>
                </div>
                <svg className="w-8 h-8 text-[#FF6B00] opacity-50" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="bg-green-50 rounded-lg p-4 border-l-4 border-green-500">
              <div className="flex items-center justify-between">
                ...
                <svg className="w-8 h-8 text-green-500 opacity-50" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="bg-blue-50 rounded-lg p-4 border-l-4 border-blue-500">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-gray-600 mb-1">Total facturé</p>
                  <p className="text-2xl font-bold text-blue-600">0€</p>
                </div>
                <svg className="w-8 h-8 text-blue-500 opacity-50" fill="none" stroke="currentColor" viewBox="0 0 24 24">
