...
const SOUS_CATEGORIES_MENUISERIE = [
  {
    titre: 'Fenêtres',
    icon: '🪟',
    couleur: '#2C3E50',
    href: '/petits-travaux-express/menuiserie/fenetres',
  },
  {
    titre: 'Portes',
    icon: '🚪',
    couleur: '#2C3E50',
    href: '/petits-travaux-express/menuiserie/portes',
  },
  {
    titre: 'Volets / Stores',
    icon: '🪟',
    couleur: '#2C3E50',
    href: '/petits-travaux-express/menuiserie/volets-stores',
  },
  {
    titre: 'Portails',
    icon: '🚧',
    couleur: '#2C3E50',
    href: '/petits-travaux-express/menuiserie/portails',
  },
];
...
export default function MenuiseriePage() {
  ...
  const filteredSousCategories = SOUS_CATEGORIES_MENUISERIE.filter(cat =>
      ...
      <div className="bg-white shadow-sm border-b border-[#E9ECEF]">
        <div className="container mx-auto px-4 py-6">
          ...
          <nav className="flex items-center gap-2 text-sm mb-4">
            ...
            <span className="text-[#6C757D]">&gt;</span>
            <span className="text-[#2C3E50] font-semibold">Menuiserie</span>
          </nav>
      ...
      <div className="bg-gradient-to-r from-[#FF6B00] to-[#E56100] py-12 mt-16">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-2xl md:text-3xl font-bold text-white mb-4">
            Besoin d'un menuisier qualifié ?
          </h2>
          <p className="text-white/90 mb-6 max-w-2xl mx-auto">
            Nos conseillers vous mettent en relation avec les meilleurs artisans menuisiers de votre région
          </p>
          <Link 
            href="/etre-rappele"
